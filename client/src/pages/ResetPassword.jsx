    ...
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0">
      ...
      {!isEmailSent && (
        <form
          ...
          className="p-10 rounded-lg shadow-lg w-96 text-sm rounded-lg shadow-lg"
        >
          ...
          <button className="w-full py-2.5 bg-black text-white rounded-full mt-3 cursor-pointer">
            Submit
          </button>
        </form>
      )}
      ...
      {isEmailSent && !isOtpSubmitted && (
        ...
        >
          ...
          <button className="w-full py-3 bg-black text-white rounded-full cursor-pointer">
            Submit
          </button>
        </form>
      )}
